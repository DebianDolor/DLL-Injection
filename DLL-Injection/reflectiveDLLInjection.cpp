...
void reflectiveDLLInjection() {
    ...
    HANDLE hFile = CreateFileA("C:\\Users\\ethic\\Desktop\\Hacktivity\\Windows Exploit\\Resources\\injector.dll", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
